...
<div class="app-suite">
  ...
  <div class="app-suite__app">
    <div class="app">
      ...
      <div class="app__platform">
        <a href="https://github.com/codaco/Network-Canvas/releases/download/v5.0.0/network-canvas-setup-5.0.0.exe" class="btn btn--sm btn--color-b">Download for<br />Windows</a>
      </div>

      <div class="app__platform">
        <a href="https://github.com/codaco/Network-Canvas/releases/download/v5.0.0/network-canvas-5.0.0.dmg" class="btn btn--sm btn--color-b">Download for<br />macOS</a>
      </div>

      <div class="app__platform">
        <a href="https://github.com/codaco/Network-Canvas/releases/tag/v5.0.0" class="btn btn--sm btn--color-b">Download for<br />Linux</a>
      </div>
  ...
  <div class="app-suite__app">
    <div class="app">
      ...
      <div class="app__platform">
        <a href="https://github.com/codaco/Architect/releases/download/v5.0.0/network-canvas-architect-setup-5.0.0.exe" class="btn btn--sm btn--color-a">Download for<br />Windows</a>
      </div>

      <div class="app__platform">
        <a href="https://github.com/codaco/Architect/releases/download/v5.0.0/network-canvas-architect-5.0.0.dmg" class="btn btn--sm btn--color-a">Download for<br />macOS</a>
      </div>

      <div class="app__platform">
        <a href="https://github.com/codaco/Architect/releases/tag/v5.0.0" class="btn btn--sm btn--color-a">Download for<br />Linux</a>
      </div>
    </div>
  </div>
